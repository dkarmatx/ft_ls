...
const t_2b		g_applyv[] = { DRW_1COL, DRW_LCOL, DRW_MCOL, RECUR_LS, \
	DIR_ASFI, SORTI_R_, SORTI_T_, SORTI_U_, SORTI_F_, SORTI_SB, ADDLF_E_, \
	ADDLF_AA, ADDLF_G_, ADDLF_H_, CUSTM_GB, CUSTM_FB, CUSTM_LB, CUSTM_AB, \
	CUSTM_A_, CUSTM_I_, CUSTM_S_, ADDLF_O_ };
